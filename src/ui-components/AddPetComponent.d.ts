...
export declare type AddPetComponentOverridesProps = {
    AddPetComponent?: PrimitiveOverrideProps<FlexProps>;
...
export declare type AddPetComponentProps = React.PropsWithChildren<Partial<FlexProps> & {
    overrides?: AddPetComponentOverridesProps | undefined | null;
}>;
export default function AddPetComponent(props: AddPetComponentProps): React.ReactElement;
